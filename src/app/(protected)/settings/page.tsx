              ...
              <CardContent className="space-y-6">
                <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                  ...
                  <div>
                    ...
                    <Input
                      ...
                      onChange={(e) =>
                        setProfileData({ ...profileData, crn: e.target.value })
                      }
                      placeholder="12345"
                    />
                  </div>
                ...
                <div>
                  ...
                  <Select
                    ...
                    onValueChange={(value) =>
                      setProfileData({ ...profileData, specialization: value })
                    }
                  >
                    <SelectTrigger>
                    ...
                    <SelectContent>
                      <SelectItem value="clinical">Nutrição Clínica</SelectItem>
                      <SelectItem value="sports">Nutrição Esportiva</SelectItem>
