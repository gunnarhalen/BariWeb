    ...
    const loadPatientData = async () => {
      ...
      try {
        ...
        const userProfile: UserProfile = {
          ...
          notifications: typeof profileData.notifications === "boolean" ? profileData.notifications : true,
          privacyMode: typeof profileData.privacyMode === "boolean" ? profileData.privacyMode : false,
          isNutritionist: Boolean(profileData.isNutritionist),
